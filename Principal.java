...
public class Principal extends Conversor {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (opcao == 7) {
                System.out.printf("\nObrigado por utilizadar o conversor de Moeda! Fim do programa.\n");
                break;
            }
